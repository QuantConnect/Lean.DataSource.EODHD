...
partial class EODHDEconomicEventsDataDownloader : EODHDBaseDataDownloader
{
    /// <summary>
    /// Provides methods to filter and standardize event names.
    /// </summary>
    public static class EventTypeFilter
    {
        ...
        private static readonly List<string> _companyReports = new() { "westpac", "markit" };

        // Strings to replace using the string `Replace(...)` method (no regex).
        // Key is current, value is the replacement
        private static readonly Dictionary<string, string> _rawReplace = new()
    {
        {"(r)", "revised"},
        {" t-bill", " bill"},
        ...
        private static readonly Dictionary<string, string> _regexReplace = new()
    {
        ...
        private static readonly Dictionary<string, string> _singleWordFilters = new()
    {
