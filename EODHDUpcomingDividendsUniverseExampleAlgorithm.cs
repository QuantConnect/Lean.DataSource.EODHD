...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    /// </summary>
    public class EODHDUpcomingDividendsUniverseExampleAlgorithm : QCAlgorithm
    {
        /// <summary>
        ...
        public override void Initialize()
        {
            ...
            var universe = AddUniverse<EODHDUpcomingDividends>(data =>
            {
                // Select the ones close to the dividend date with dividend payment above threshold.
                return from EODHDUpcomingDividends d in data
                       where d.DividendDate <= Time.AddDays(3) && d.Dividend > 0.05m
                       select d.Symbol;
            });
